...
Lemma lfind_state   (a : list nat) (b : list nat) : @Permutation nat (@cons nat (S (S (S (S (S (S O)))))) (@app nat a b)) ?l'.
Admitted.

From QuickChick Require Import QuickChick.
QCInclude "/home/anabrendel/lfind/vfa-benchmarks/Perm/benchmarks/_lfind_perm_lemma_Permutation_app_comm_IN_permut_example/".
QCInclude ".".
...
Definition collect_data (a : list nat) (b : list nat) :=
 let lfind_var := "a:" ++ "(" ++ show a ++ ")"++ "|" ++"b:" ++ "(" ++ show b ++ ")"
 in let lfind_v := print b lfind_var
 in lfind_state a lfind_v.
