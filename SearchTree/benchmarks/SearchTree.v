(** * SearchTree: Binary Search Trees *)
   ...
   Definition combine {A} (pivot: nat) (m1 m2: total_map A) : total_map A :=
   ...
   *)
   ...
   (** A [tree] has the [SearchTree] property if, at any node with nat
        [k], all the nats in the left subtree are less than [k], and all
        the nats in the right subtree are greater than [k].  It's not
